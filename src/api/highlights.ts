...
// 하이라이트 생성
export const createHighlight = async (data: CreateHighlightRequest): Promise<HighlightResponse> => {
    const response = await apiClient.post<ApiResponse<HighlightResponse>>('/highlights', data);
